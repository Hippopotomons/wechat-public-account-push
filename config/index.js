export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxde920ba740203667",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "878817ccbe8a5e00ec36832cff8f2d2e",
  ...
  USERS: [
    {
      ...
      id: "oy4175oAHdTUcXRiBxK1zW6c-hSs",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "Lu1HqXy20Nk1rftVOT2ZZZpmh50MJwCvjBmS1hRgeyE",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "秀山",
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        {"keyword": "marry_day", date: "2021-06-24"},
        // 退伍日
  ...
  CALLBACK_TEMPLATE_ID: "Lu1HqXy20Nk1rftVOT2ZZZpmh50MJwCvjBmS1hRgeyE",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oy4175tbwq7BEKKxh0TrKVqQy1Q0",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
